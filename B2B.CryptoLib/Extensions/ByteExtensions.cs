...
namespace B2B.CryptoLib.Extensions
{
    ...
    /// </summary>
    /// <remarks>這些方法只做表示法轉換，不會清除或保護輸入 bytes；呼叫端仍須妥善處理金鑰材料。</remarks>
    public static class ByteExtensions
    {
        /// <summary>將 bytes 編碼為標準 Base64 字串。</summary>
        /// <param name="data">要編碼的 bytes；不可為 <see langword="null"/>。</param>
        /// <returns>包含 padding 的標準 Base64 表示。</returns>
        ...
        /// <summary>將 bytes 轉成不含分隔符號的大寫十六進位字串。</summary>
        /// <param name="data">要轉換的 bytes；不可為 <see langword="null"/>。</param>
        /// <returns>每個 byte 對應兩個大寫十六進位字元的字串。</returns>
        /// <exception cref="ArgumentNullException"><paramref name="data"/> 為 <see langword="null"/>。</exception>
        public static string ToHex(this byte[] data) => BitConverter.ToString(data).Replace("-", "");

        /// <summary>以 UTF-8 解碼 bytes。</summary>
        /// <param name="data">要解碼的 bytes；不可為 <see langword="null"/>。</param>
