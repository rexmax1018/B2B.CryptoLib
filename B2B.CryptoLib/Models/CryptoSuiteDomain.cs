...
namespace B2B.CryptoLib.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// 這個舊版領域包裝器會從 <see cref="KeyManagerService.GetLatestActiveUnifiedName"/>
    /// 取得 Current 中排序後的最新名稱；需要明確且可隔離的執行脈絡時，請優先使用
    ...
    public class CryptoSuiteDomain
    {
        ...
        /// <summary>
        /// 建立使用指定金鑰管理器與資料加密服務的領域包裝器。
        /// </summary>
        /// <param name="keyManagerService">提供啟用金鑰組查找的服務。</param>
